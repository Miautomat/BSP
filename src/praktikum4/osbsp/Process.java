...
/*
 * Process Repr�sentation eines unabh�ngigen Prozess-Objekts
 */

/**
 * Programm-Simulation: Daten eines Prozesses verwalten (PCB) sowie
 * Laufzeitverhalten simulieren, d.h. read-Operationen im eigenen virtuellen
 * Speicher ausf�hren (Pseudo-Zufallszahlengeneratorgesteuert) mit mehreren
 * Operationen im selben Seitenbereich (gem�� "Lokalit�tsfaktor")
 */
    ...
    public void run() {
        ...
        while (!isInterrupted()) {
            ...
            for (i = 0; i < localityFactor; i++) {
                // Virtuelle Adresse in der "N�he" des Mittelwerts (median)
                // bestimmen
