...
public class OperatingSystem {
	...
	private int getVirtualPageNum(int virtAdr) {
		 ...
		 * der seitengröße teilen.
		 * 
		 * Bei einer Seitengröße von 256 gehen die Adressen von Adresse 0 bis
		 * 256.
		 * 
		 * 0 ╔ ║ Seite 0 ║ 256 ╚ 257 ╔ ~300 -> ║ Seite 1 ║ 512 ╚
		 * 
		 * Als beispiel: wenn wir die Adresse 300 bekommen, so teilen wir 300
		 * durch 256.
		 * 
		 * 300/256=1.171875
		 * 
		 * Wenn nur der Wert vor dem Komma betrachtet wird, sagt dies 1. Die
		 * Adresse befindet sich also auf der Seite 1.
		 * 
		 */
	...
	private int getNewRAMPage(PageTableEntry newPte, int pid) {
		...
		if (proc.pageTable.getSize() < MAX_RAM_PAGES_PER_PROCESS) {
			...
			// Nein, Seitenanforderung im RAM ist nicht erfï¿½llbar:
			testOut("OS: getNewRAMPage " + pid + " ++ Seitenfehler fï¿½r Seite " + newPte.virtPageNum
					+ " --> Seitenersetzungs-Algorithmus!");
			// eine alte Seite zur Verdrï¿½ngung auswï¿½hlen -->
			// Seitenersetzungs-Algorithmus
