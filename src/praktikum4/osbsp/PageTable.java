...
public class PageTable {
    ...
    public PageTableEntry selectNextRAMpteAndReplace(PageTableEntry newPte) {
        if (os
            .getReplacementAlgorithm() == OperatingSystem.ImplementedReplacementAlgorithms.CLOCK) {
            return clockAlgorithm(newPte);
        } else {
            if (os
                .getReplacementAlgorithm() == OperatingSystem.ImplementedReplacementAlgorithms.FIFO) {
    ...
    private PageTableEntry clockAlgorithm(PageTableEntry newPte) {
        ...
        pte = pteRAMlist.get(pteRAMlistIndex);
